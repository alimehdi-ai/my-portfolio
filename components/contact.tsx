    ...
    <section id="contact" className="py-20 px-6 relative" ref={ref}>
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              {contactMethods.map(({ Icon, text, color, link }, idx) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group flex items-center space-x-4 p-4 rounded-2xl hover:bg-white/50 dark:hover:bg-gray-800/50 transition-all duration-300"
                >
                  <motion.div
                    className={`p-3 bg-gradient-to-r ${color} rounded-2xl transition-all duration-300`}
          ...
          <motion.div 
            className="relative"
            variants={slideIn('right', 60)}
          >
            <motion.div 
              className="absolute -inset-4 bg-gradient-to-r from-blue-400 to-purple-500 opacity-20 blur-2xl rounded-3xl"
              animate={{
                scale: [1, 1.05, 1],
                opacity: [0.2, 0.3, 0.2],
              }}
            ...
            />
            <motion.div 
              className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-8 rounded-3xl border border-white/20 dark:border-gray-700/30 shadow-2xl"
              variants={scaleIn}
              whileHover={{ y: -5 }}
            >
              <motion.div 
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group relative w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-2xl font-semibold transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 overflow-hidden"
                >
